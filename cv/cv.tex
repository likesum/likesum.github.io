...
% \B{Refereed}
\begin{enumerate}
  % \item Yifan Jiang, Jiawen Chen, Zhiwen Fan, Xuaner (Cecilia) Zhang, Xiuming Zhang, Zhangyang Wang, \B{Zhihao Xia}. ``High-Quality Depth Estimation using Smartphone RGB-D Cameras'', \pub{In Submission}.
  \item Zheng Ding, Xuaner (Cecilia) Zhang, \B{Zhihao Xia}. ``Restoration by Generation with Constrained Priors'', \pub{arXiv}, 2023.
